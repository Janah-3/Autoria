...
{
    public class AddTimeSlotHandler : IRequestHandler<AddTimeSlotCommand, Guid>
    {
        private readonly AppDbContext _db;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public AddTimeSlotHandler(AppDbContext db, IHttpContextAccessor httpContextAccessor)
        {
            _db = db;
