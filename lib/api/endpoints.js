...
export const BOOKINGS_ENDPOINTS = {
  ...
  blockSlotPost: "/bookings/slots/block",
...
export const MILEAGE_ENDPOINTS = {
  base: "/mileage",
  history: (carId) => `/mileage/${carId}/history`,
  reminders: "/mileage/reminders",
  reminderById: (id) => `/mileage/reminders/${id}`,
};
...
export const REVIEWS_ENDPOINTS = {
  base: "/Reviews",
  submit: "/Reviews",              // POST /Reviews (multipart/form-data)
  mine: "/Reviews/mine",           // GET  /Reviews/mine
  byId: (id) => `/Reviews/${id}`,  // DELETE /Reviews/{id}  |  PUT /Reviews/{id}
  forServiceCenter: (id) => `/Reviews/service-centers/${id}`, // GET /Reviews/service-centers/{id}
};
